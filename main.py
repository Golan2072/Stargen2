...
def star_renderer (starmap, map_column, map_row):
                if map_column % 2 != 0:
                    ...
                    elif starmap[map_column][map_row].startype in ["0", "&", "#"]:
                        pygame.draw.circle(screen, (0, 255, 0), (80*map_column*1.5, 140*map_row-60), 20, 2)
                    else:
                        pass
                    map_font.render_to(screen, (80*map_column*1.5-40, 140*map_row-10), starmap[map_column][map_row].names, (0, 255, 0))
                    starport_font.render_to(screen, (80*map_column*1.5-5, 140*map_row-120), starmap[map_column][map_row].starport, (0, 255, 0))
                    if starmap[map_column][map_row].gas_giant == "*":
                        pygame.draw.circle(screen, (0, 255, 0), (80*map_column*1.5+30, 140*map_row-100), 6, 0)
                    else:
                        pass
                    if starmap[map_column][map_row].scout == "S":
                        draw_regular_polygon(screen, (0, 255, 0), 3, 10, (80*map_column*1.5-40, 140*map_row-25), 0)
                    else:
                        pass
                    if starmap[map_column][map_row].naval == "N":
                        draw_regular_polygon(screen, (0, 255, 0), 4, 10, (80*map_column*1.5-40, 140*map_row-80), 0)
                    else:
                        pass
                if map_column % 2 == 0:
                    if starmap[map_column][map_row].startype == "@":
                        ...
                        pass
                    map_font.render_to(screen, (80*map_column*1.5-40, 140*map_row+54), starmap[map_column][map_row].names, (0, 255, 0))
                    starport_font.render_to(screen, (80*map_column*1.5-5, 140*map_row-50), starmap[map_column][map_row].starport, (0, 255, 0))
                    if starmap[map_column][map_row].gas_giant == "*":
                        pygame.draw.circle(screen, (0, 255, 0), (80*map_column*1.5+30, 140*map_row-30), 6, 0)
                    else:
                        pass
                    if starmap[map_column][map_row].scout == "S":
                        draw_regular_polygon(screen, (0, 255, 0), 3, 10, (80*map_column*1.5-40, 140*map_row+40), 0)
                    else:
                        pass
                    if starmap[map_column][map_row].naval == "N":
                        draw_regular_polygon(screen, (0, 255, 0), 4, 10, (80*map_column*1.5-40, 140*map_row-20), 0)
                    else:
                        pass
